...
export const mockTrips: TripResponse[] = [
  {
    ...
    mood: 'CULTURAL',
    type: 'SOLO',
    coverMediaUrl: 'https://images.pexels.com/photos/2506923/pexels-photo-2506923.jpeg?auto=compress&cs=tinysrgb&w=600',
    ...
    threadEntries: [
      {
        ...
        authorId: '1',
        type: 'TEXT',
        contentText: 'Just arrived in Tokyo! The energy here is incredible. First stop: Shibuya Crossing to experience the famous organized chaos. The jetlag is real but the excitement is keeping me going! 🇯🇵',
      ...
      },
      {
        ...
        authorId: '1',
        type: 'MEDIA',
        contentText: 'Lunch at this hidden ramen shop recommended by a local. The broth is absolutely divine!',
        mediaUrl: 'https://images.pexels.com/photos/1907228/pexels-photo-1907228.jpeg?auto=compress&cs=tinysrgb&w=600',
        locationName: 'Menya Saimi',
        gpsCoordinates: { lat: 35.6580, lng: 139.7016 },
      ...
      },
      {
        ...
        authorId: '1',
        type: 'CHECKIN',
        contentText: 'Peaceful morning at Senso-ji Temple. The contrast between ancient traditions and modern Tokyo is fascinating.',
  ...
  },
  {
    ...
    mood: 'RELAXED',
    type: 'SOLO',
    coverMediaUrl: 'https://images.pexels.com/photos/3073666/pexels-photo-3073666.jpeg?auto=compress&cs=tinysrgb&w=600',
    ...
    threadEntries: [
      {
        ...
        authorId: '1',
        type: 'MEDIA',
        contentText: 'Sunset at Tanah Lot Temple. No words can describe this beauty.',
        mediaUrl: 'https://images.pexels.com/photos/2161449/pexels-photo-2161449.jpeg?auto=compress&cs=tinysrgb&w=600',
  ...
  },
  {
    ...
    mood: 'ADVENTURE',
    type: 'SOLO',
    coverMediaUrl: 'https://images.pexels.com/photos/1586298/pexels-photo-1586298.jpeg?auto=compress&cs=tinysrgb&w=600',
